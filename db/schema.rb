...
ActiveRecord::Schema.define(version: 20161213231307) do
  ...
  create_table "flashcard_items", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "quiz_questions", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
  ...
  create_table "sessions", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    ...
    t.index ["session_id"], name: "index_sessions_on_session_id", unique: true, length: {"session_id"=>1000}, using: :btree
  end
